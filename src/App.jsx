      ...
      <footer id="kontak" className="py-16 md:py-20 bg-gray-950 text-white text-center px-6">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex justify-center gap-4 md:gap-6 mb-12 md:mb-16">
            ...
            <a href="https://t.me/username_kamu" target="_blank" rel="noopener noreferrer" className="p-3.5 md:p-4 bg-gray-900 rounded-full hover:bg-blue-500 text-gray-300 transition-all duration-300 shadow-md" title="Telegram">
